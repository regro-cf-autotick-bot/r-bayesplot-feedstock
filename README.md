...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-bayesplot-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-bayesplot-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-bayesplot
# for installing globally
pixi global install r-bayesplot
```
...
It is possible to list all of the versions of `r-bayesplot` available on your platform:
...
```
pixi search r-bayesplot --channel conda-forge
```
